...
```js
import {shortHeaders, formats, crest, clubInfo} from "./components/labels.js";
import {crestHref} from "./components/crests.js";
const teamFmt = (v, i, rows) => { const s = document.createElement("span"); s.className = "club-cell"; s.append(crest(rows[i].club, 18), document.createTextNode(" " + rows[i].club)); return s; };
...
<div class="card">
  ...
  ${resize((width) => Plot.plot({width, height: 420, grid: true, inset: 24,
