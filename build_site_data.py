...
LABELS = {
    ...
    "gd_off_pitch_per90": ("Team goal difference per 90 off pitch", "GD/90 off", "Team goal difference per 90 in matches the player appeared in, for the minutes they weren't on the field (min 450 such minutes)", "dec", True, True),
    "gd_on_off_diff": ("On-pitch vs off-pitch goal difference", "On/off GD", "On-pitch GD/90 minus off-pitch GD/90, in the same matches the player appeared in (min 450 off-pitch minutes)", "dec", True, True),
...
PLAYER_COLS = ["player_id", "player_name", "club", "team", "team_id", "league", "grade", "division", "role", "jersey",
               ...
               "gd_off_pitch_per90", "gd_on_off_diff",
